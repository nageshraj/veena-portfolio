    ...
    >
        <div className="text-center mb-16">
            <motion.h1
                ...
                className="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-amber-200 to-amber-500"
            >
                About the Artist
            </motion.h1>
            <motion.p
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            >
                <div className="bg-gradient-to-br from-amber-600 to-amber-700 rounded-2xl h-96 flex items-center justify-center">
                    <Music className="w-32 h-32 text-white opacity-30" />
                </div>
            </motion.div>
            ...
            >
                <h2 className="text-3xl font-bold text-amber-500 mb-6">Musical Journey</h2>
        ...
        >
            <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-800">
                ...
                <h3 className="text-xl font-bold text-amber-500 mb-2">Achievements</h3>
            ...
            <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-800">
                ...
                <h3 className="text-xl font-bold text-amber-500 mb-2">Teaching Legacy</h3>
                <ul className="text-neutral-300 space-y-2">
            ...
            <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-800">
                ...
                <h3 className="text-xl font-bold text-amber-500 mb-2">Specializations</h3>
                <ul className="text-neutral-300 space-y-2">
...
export const Vocal = () => (
    ...
    >
        ...
        <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
            className="bg-neutral-900/50 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-neutral-800"
        >
            <h2 className="text-3xl font-bold text-amber-500 mb-6">Training Programs</h2>
        ...
        <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3 }}
            className="bg-gradient-to-r from-amber-900/20 to-purple-900/20 rounded-2xl p-8 border border-amber-800/30"
        >
            <h2 className="text-2xl font-bold text-amber-500 mb-6 text-center">Student Testimonials</h2>
            <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-neutral-900/50 rounded-xl p-6">
                    ...
                    <p className="text-amber-400 font-semibold">- Priya S., Advanced Student</p>
                </div>
                <div className="bg-neutral-900/50 rounded-xl p-6">
                    <p className="text-neutral-300 italic mb-4">
                        "Perfect blend of traditional teaching methods with modern accessibility. The online classes are just as effective!"
                    </p>
                    <p className="text-amber-400 font-semibold">- Rajesh K., Intermediate Student</p>
                </div>
            </div>
        </motion.div>
    </motion.div>
...
export const Veena = () => (
    ...
    >
        ...
        <motion.div
            ...
            className="bg-neutral-900/50 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-neutral-800"
        >
            <h2 className="text-3xl font-bold text-amber-500 mb-6">About the Veena</h2>
        ...
        >
            <div className="bg-gradient-to-br from-amber-900/30 to-neutral-900/30 rounded-xl p-6 border border-amber-800/30">
                <h3 className="text-xl font-bold text-amber-400 mb-4">Beginner Level</h3>
            ...
            <div className="bg-gradient-to-br from-amber-900/30 to-neutral-900/30 rounded-xl p-6 border border-amber-800/30">
                <h3 className="text-xl font-bold text-amber-400 mb-4">Intermediate Level</h3>
                <ul className="text-neutral-300 space-y-2 text-sm">
            ...
            <div className="bg-gradient-to-br from-amber-900/30 to-neutral-900/30 rounded-xl p-6 border border-amber-800/30">
                <h3 className="text-xl font-bold text-amber-400 mb-4">Advanced Level</h3>
                <ul className="text-neutral-300 space-y-2 text-sm">
        ...
        >
            <h2 className="text-2xl font-bold text-amber-500 mb-6">Class Information</h2>
            <div className="grid md:grid-cols-2 gap-8">
                <div>
                    <h3 className="text-lg font-semibold text-amber-400 mb-4">Learning Methodology</h3>
                    <ul className="text-neutral-300 space-y-3">
                        <li className="flex items-start">
                            <span className="text-amber-500 mr-2">✓</span>
                ...
                <div>
                    <h3 className="text-lg font-semibold text-amber-400 mb-4">Class Formats</h3>
                    <ul className="text-neutral-300 space-y-3">
                        <li className="flex items-start">
                            <span className="text-amber-500 mr-2">✓</span>
